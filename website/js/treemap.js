...
/* d3.json('data/swiss-carbon-footprint.json', function (error, data) { */
  console.log("OK");
  ...
  on("mousemove", function (d) {
    ...
    tooltip.style("color", color(d.data.category));
  ...
  var firstspacing = (width-250-200-180-200)/2
  console.log('firstspacing=', firstspacing)
  ...
  attr("transform", function (d, i) {
      return 'translate(0, ' + (i * (LEGEND_RECT_SIZE + LEGEND_V_SPACING)) + ')';
  }).
  attr('fill', function (d) {
    return color(d);
  });
